...
class ReflectionHelper {
    ...
    static Method[] getMethods(Class tempClass) {
        try {
            return tempClass.getDeclaredMethods();
    ...
    static Annotation[] getAnnotations(Method tempMethod){
        try {
            return tempMethod.getDeclaredAnnotations();
        } catch (SecurityException e) {
            e.printStackTrace();
        }
        return null;
